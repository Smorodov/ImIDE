 ...
 *  @ingroup window
 */
GLFWAPI GLFWwindow* glfwCreateWindow(int full_width, int full_height, const char* title, GLFWmonitor* monitor, GLFWwindow* share);
 ...
 *  @ingroup window
 */
GLFWAPI void glfwGetWindowSize(GLFWwindow* window, int* full_width, int* full_height);
 ...
 *  @ingroup window
 */
GLFWAPI void glfwSetWindowSize(GLFWwindow* window, int full_width, int full_height);
 ...
 *  @ingroup window
 */
GLFWAPI void glfwGetFramebufferSize(GLFWwindow* window, int* full_width, int* full_height);
 ...
 *  @ingroup window
 */
GLFWAPI void glfwSetWindowMonitor(GLFWwindow* window, GLFWmonitor* monitor, int xpos, int ypos, int full_width, int full_height, int refreshRate);
